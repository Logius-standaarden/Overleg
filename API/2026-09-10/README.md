...
### Kleine wijzigingen
* API-Design-Rules [issue #347] [Sta QUERY method toe als http method](https://github.com/Logius-standaarden/API-Design-Rules/issues/347) (10 juli 2026)

### Overige punten
* API-Design-Rules [issue #354] [Voeg regel toe voor het teruggeven van objecten voor collection resources](https://github.com/Logius-standaarden/API-Design-Rules/pull/354) (14 augustus 2026), _Status: In bewerking_
...
* API-Design-Rules [issue #349] [Rule `/core/no-trailing-slash` uitbreiden (`//` ook uitsluiten)](https://github.com/Logius-standaarden/API-Design-Rules/issues/349) (16 juli 2026)
