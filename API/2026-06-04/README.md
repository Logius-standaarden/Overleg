...
### Overige punten
* API-Design-Rules [issue #327] [Publiceer 2.2 versie ter vaststelling](https://github.com/Logius-standaarden/API-Design-Rules/pull/327) (6 mei 2026), _Status: Ter goedkeuring_
* API-Design-Rules [issue #326] [Voeg expliciete velden toe aan `info.contact` regel](https://github.com/Logius-standaarden/API-Design-Rules/pull/326) (6 mei 2026), _Status: In bewerking_
