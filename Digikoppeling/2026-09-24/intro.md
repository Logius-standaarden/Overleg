...
Onderzoek GraphQL is opgenomen op de Digikoppelikng Roadmap : [Onderzoek GraphQL](https://gitdocumentatie.logius.nl/publicatie/dk/roadmap/2026-2027/#onderzoek-uitbreiding-digikoppeling-met-graphql)
...
Er zijn ook al ideeën over wat waardevol is om in een GraphQL profiel op te nemen : bv standaardiseren error afhandeling;

Binnen het Kennsiplatform API's is GraphQL ook al langere tijd op de radar. Daarom is het voorstel om een GraphQL profiel binnen / in samenwerking met het Kennisplatform APi's te ontwikkelen.
